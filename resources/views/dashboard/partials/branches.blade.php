...
<div class="section" style="padding: 0;">
    <div class="card black-text" style="margin-bottom: 5px;">
        <div class="container" style="width: 90%;">
            <p style="padding: 5px 0 0 0; margin-bottom: 5px;">Plaza sendero</p>
            ...
            <div class="row">
                ...
                <div class="col s6 right-align">
                    <span style="font-weight: 200;font-size:19px;">150,000</span>
                </div>
    ...
    <div class="card black-text" style="margin-bottom: 2px;">
        <div class="container" style="width: 90%;">
            <p style="padding: 5px 0 0 0; margin-bottom: 5px;">Plaza sendero</p>
            <div class="divider grey darken-1"></div>
            <div class="row">
