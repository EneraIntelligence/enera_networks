...
@section('content')
    ...
    @if( count($campaigns) == 0 )
        <div class="empty-message" style="width: 80%; margin:20px auto 0;">
            <img style="margin:0 auto; width:200px; display:block;"
                 src="{!! URL::asset('images/icons/banner_new.svg') !!}" alt="">
    ...
    <div class="fixed-action-btn" style="bottom: 55px; right: 24px;">
        ...
        @if( count($campaigns) == 0 )
            <i class="large material-icons animated-arrow grey-text"
               style="right: -15px; bottom: 30px; position: absolute;">arrow_drop_down</i>
        @endif
                ...
                <form class="col m12 s12 formValidate" action="/campaigns/new" method="get" id="validate"
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m2 s3">
                            ...
                            <button type="submit" class="sbm-button waves-light teal lighten-2" id="btn-modal">Crear
                            </button>
                        </div>
                    </div>
                </form>
