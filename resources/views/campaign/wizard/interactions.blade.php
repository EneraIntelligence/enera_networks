<div id="interactions_container">
    ...
    <ul class="collection side-margin-20px clickable">
        ...
        <li class="collection-item avatar animate-all" id="banner_link" data-interaction="banner_link">
            <img class="circle indigo lighten-4 animate-all" style="margin-top:10px;"
                 src="{{ asset("images/icons/banner_link.svg") }}" alt="banner icon">
        ...
        <li class="collection-item avatar animate-all" id="captcha" data-interaction="captcha">
            <img class="circle indigo lighten-4 animate-all" style="margin-top:10px;"
                 src="{{ asset("images/icons/captcha.svg") }}" alt="captcha icon">
